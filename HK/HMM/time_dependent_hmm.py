...
local_coeff = '/Users/kristina/PycharmProjects/vyskumak/diplomka/final_experiments/modified_hmm/transition_matrices/coeffs.csv'

server_data = "/disk/bios/blaskova/kod/data/patients/"
server_list = "/disk/bios/blaskova/kod/list_of_patients_with_attributes.csv"
server_coeff = '/disk/bios/blaskova/kod/coeffs/coeffs_nowake.csv'
...
if place == 'local':
    ...
    pred_dir='/Users/kristina/PycharmProjects/vyskumak/diplomka/final_experiments/modified_hmm/results/predicted_states/'
...
scores=[]
max_ids=[]
precision_tables = open('/Users/kristina/PycharmProjects/vyskumak/diplomka/final_experiments/modified_hmm/results/pt.txt', 'w')
confusion_matrices = open('/Users/kristina/PycharmProjects/vyskumak/diplomka/final_experiments/modified_hmm/results/cms.txt', 'w')
maximal_indices = open('/Users/kristina/PycharmProjects/vyskumak/diplomka/final_experiments/modified_hmm/results/HMM_find_a_max_ids.txt', 'w')
scores_file = open('/Users/kristina/PycharmProjects/vyskumak/diplomka/final_experiments/modified_hmm/results/scores.txt', 'w')
...
for i in range(0, len(list_of_patients['file_name'])):
    ...
    for k in range(list_of_testing_patients.shape[0]):
        ...
        if grouped_states[0][0] == 'Wake':
            ...
            skutocna_dlzka=0
        plt.plot([i/2.0 for i in range(0,len(best_path_probs))],best_path_probs,label='Path probability')
        plt.xlabel('Minutes')
        ...
        plt.legend()
        plt.savefig( '/Users/kristina/PycharmProjects/vyskumak/diplomka/final_experiments/modified_hmm/results/plots_a/' + str(i) + '.png')
        plt.close()
        #tu klasicky hmm
