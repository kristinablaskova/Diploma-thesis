...
if place == 'local':
    ...
    plist = local_list
    precision_tables = open('/Users/kristina/PycharmProjects/vyskumak/diplomka/final_experiments/knn_balanced/results/pt.txt', 'w')
    confusion_matrices = open('/Users/kristina/PycharmProjects/vyskumak/diplomka/final_experiments/knn_balanced/results/cms.txt', 'w')
    scores_file = open('/Users/kristina/PycharmProjects/vyskumak/diplomka/final_experiments/knn_balanced/results/scores.txt', 'w')
    pred_dir='/Users/kristina/PycharmProjects/vyskumak/diplomka/final_experiments/knn_balanced/results/predicted_states/'
    ...
    plist = server_list
    precision_tables = open('/disk/bios/blaskova/vysledky/knn_manhatan_pt.txt', 'w')
    confusion_matrices = open('/disk/bios/blaskova/vysledky/knn_manhatan_cms.txt', 'w')
    scores_file = open('/disk/bios/blaskova/vysledky/knn_manhatan_scores.txt', 'w')
