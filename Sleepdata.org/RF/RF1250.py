...
if place == 'local':
    ...
    precision_tables = open('/Users/kristina/PycharmProjects/vyskumak/kod_sleep_org/RF_balanced/RF_balanced_pt.txt', 'w')
    confusion_matrices = open('/Users/kristina/PycharmProjects/vyskumak/kod_sleep_org/RF_balanced/RF_balanced_cms.txt', 'w')
    scores_file = open('/Users/kristina/PycharmProjects/vyskumak/kod_sleep_org/RF_balanced/RF_balanced_scores.txt', 'w')
    ...
    precision_tables = open('/disk/bios/blaskova/kod_sleep_org/RF_balanced/RF_balanced_pt' + str(do) + '.txt', 'w')
    confusion_matrices = open('/disk/bios/blaskova/kod_sleep_org/RF_balanced/RF_balanced_cms' + str(do) + '.txt', 'w')
    scores_file = open('/disk/bios/blaskova/kod_sleep_org/RF_balanced/RF_balanced_scores' + str(do) + '.txt', 'w')
    pred_dir = '/disk/bios/blaskova/kod_sleep_org/RF_balanced/predicted_states/'
...
wakes.to_csv('/disk/bios/blaskova/kod_sleep_org/RF_balanced/RF_balanced_wlengths' + str(do) + '.csv')
