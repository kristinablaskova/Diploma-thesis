...
local_cfeatures = '/Users/kristina/PycharmProjects/vyskumak/kod_sleep_org/RF/common_features.txt'
...
if place == 'local':
    ...
    precision_tables = open('/Users/kristina/PycharmProjects/vyskumak/kod_sleep_org/RF/rf_pt.txt', 'w')
    confusion_matrices = open('/Users/kristina/PycharmProjects/vyskumak/kod_sleep_org/RF/rf_cms.txt', 'w')
    scores_file = open('/Users/kristina/PycharmProjects/vyskumak/kod_sleep_org/RF/rf_scores.txt', 'w')
    ...
    precision_tables = open('/disk/bios/blaskova/kod_sleep_org/knn_balanced/pt' + str(do) + '.txt', 'w')
    confusion_matrices = open('/disk/bios/blaskova/kod_sleep_org/knn_balanced/cms' + str(do) + '.txt', 'w')
    scores_file = open('/disk/bios/blaskova/kod_sleep_org/knn_balanced/scores' + str(do) + '.txt', 'w')
    pred_dir='/disk/bios/blaskova/kod_sleep_org/knn_balanced/predicted_states/'
...
for i in range(od, do):
    ...
    classifier = KNeighborsClassifier(n_neighbors=150,weights='distance')
    classifier.fit(X, y)
...
wakes.to_csv('/disk/bios/blaskova/kod_sleep_org/knn_balanced/knn_wlengths' + str(do) + '.csv')
